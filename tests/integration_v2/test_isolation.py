...
async def test_filesystem_barrier(reference_host):
    ...
    try:
        ...
        # Let's try to write to a path that is definitely NOT bound, e.g. the test file itself if in a private dir?
        # Actually, let's try to write to /home/johnj/pyisolate (source code) - assuming default doesn't allow write?
